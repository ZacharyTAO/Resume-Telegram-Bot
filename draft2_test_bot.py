...
# Callback data
ONE, TWO, THREE, FOUR , FIVE, SIX, SEVEN, EIGHT, Q1, Q2, Q3, Q4= range(12)
...
def main_menu(update: Update, context: CallbackContext) -> int:
    ...
    keyboard = [
        ...
        [
            ...
            InlineKeyboardButton("End", callback_data=str(SIX)),
        ]
    ]
...
def back_question_menu(update: Update, context: CallbackContext) -> int:
    """Show new choice of buttons"""
    query = update.callback_query
    query.answer()
    keyboard = [
    ...
    conv_handler = ConversationHandler(
        ...
        states={
            FIRST: [
                ...
                CallbackQueryHandler(back_question_menu, pattern='^' + str(EIGHT) + '$'),
                CallbackQueryHandler(back_main_menu, pattern='^' + str(FIVE) + '$'),
